...
class _PhotoItemState extends State<PhotoItem> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final Animation<double> easeSelection =
        CurvedAnimation(parent: _selectController, curve: Curves.easeIn);
    ...
    final Animation<double> easeInsert =
        CurvedAnimation(parent: _replaceController, curve: Curves.easeIn);
...
class _ImageDemoState extends State<ImageDemo>
  ...
  Widget _buildPhotoBlock(
    ...
    for (int rowIndex = 0; rowIndex < photoBlockFrames.length; rowIndex += 1) {
      ...
      final int rowLenght = photoBlockFrames[rowIndex].length;
      for (var frameIndex = 0; frameIndex < rowLenght; frameIndex += 1) {
        ...
        body: SizedBox.expand(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildPhotoBlock(context, index, photoBlockFrameCount);
            },
          ),
        ));
  }
